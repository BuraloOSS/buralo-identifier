...
class IdentifierConverterTest {
    ...
    @ParameterizedTest
    @MethodSource
    void conversionSuccesses(final String version,
                             final String text,
                             final Identifier identifier) {
        final var identifierConverter = new IdentifierConverter(UUIDIdentifierService.forVersion(version));
        assertThat(identifierConverter.convert(text, Identifier.class)).hasValue(identifier);
    }
    ...
    @ParameterizedTest
    @MethodSource
    void conversionFailures(final String version,
                            final String text) {
        final var identifierConverter = new IdentifierConverter(UUIDIdentifierService.forVersion(version));
        assertThat(identifierConverter.convert(text, Identifier.class))
                .isEmpty();
    }
}
