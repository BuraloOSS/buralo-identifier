...
class TestUUIDIdentifierServiceV4 {
    ...
    private final IdentifierService identifierService =  UUIDIdentifierService.forVersion(UUIDIdentifierService.V4);
    ...
    void generatedIdentifierIsConsistent() {
        assertThat(identifierService.generate())
                .satisfies(identifier -> {
                    ...
                    assertThat(identifier.uuid().version()).isEqualTo(4);
                });
    }
