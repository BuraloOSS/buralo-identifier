...
public class IdentifierJacksonModule extends SimpleModule {
    ...
    public IdentifierJacksonModule(final IdentifierService identifierService) {
        ...
        addDeserializer(Identifier.class, new IdentifierJacksonDeserializer(identifierService));
        addKeyDeserializer(Identifier.class, new IdentifierJacksonKeyDeserializer(identifierService));
    }
}
