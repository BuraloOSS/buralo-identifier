 ...
 */
public class IdentifierJacksonDeserializer extends StdDeserializer<Identifier> {
     ...
     */
    public IdentifierJacksonDeserializer(final IdentifierService identifierService) {
